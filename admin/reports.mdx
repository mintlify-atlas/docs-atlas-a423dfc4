...
<CardGroup cols={3}>
  <Card title="Alcoholic beverages" icon="wine-glass" href="#alcoholic-beverage-reports">
    Complete report of all beverage sales permits
  </Card>
  <Card title="Advertising" icon="bullhorn" href="#advertising-reports">
    Full advertising and propaganda permit report
  </Card>
  <Card title="Special events" icon="calendar" href="#event-reports">
